...
<body>
    <div class="home-button-container">
        <a href="/">
            <button class="home-page-button">ESILEHELE</button>
        </a>
    </div>
    
    <div class="text-container">
        <div id="form">
            <div class="text">Laadi ülesse oma küsimused</div>
            <form style="display: flex; justify-content: center;" action="upload.php" method="post" enctype="multipart/form-data">
                <label id="file-upload">Vali fail
                    <input type="file" name="json">
                </label>
                <br>
                <input id="submit-button" class="button" type="submit" value="Lae ülesse">
            </form>
